...
export default function DeliveryPage() {
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      <p className="text-xs uppercase tracking-[0.22em] text-leaf">Delivery</p>
      ...
      <section className="mt-10 rounded-[28px] bg-white/80 p-8">
        <h2 className="font-display text-3xl text-forest">Collect at the nursery</h2>
        <p className="mt-3 text-ink/65">
          Prefer no delivery? Choose collection at checkout and pick up your trees at Greenhouse Co-Op in Belmopan. No delivery or courier fee.
        </p>
      </section>
